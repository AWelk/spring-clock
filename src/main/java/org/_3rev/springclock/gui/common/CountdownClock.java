...
public class CountdownClock extends SubPanel {

    public CountdownClock(PApplet parent) {
        super(parent);
    }

    public CountdownClock(PApplet parent, float x1, float y1, float x2, float y2) {
